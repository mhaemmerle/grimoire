...
cljs.core.UUID;
goog.provide("grimoire_client.core");
goog.require("cljs.core");
grimoire_client.core.on_open = function on_open(event) {
  return console.log("connection open")
};
grimoire_client.core.on_message = function on_message(event) {
  return console.log("received message", event)
};
grimoire_client.core.on_error = function on_error(event) {
  return console.log("error", event)
};
grimoire_client.core.init = function init(user_id) {
  var source__51934 = new EventSource([cljs.core.str("http://localhost:4000/"), cljs.core.str(user_id), cljs.core.str("/events")].join(""));
  source__51934.addEventListener("open", grimoire_client.core.on_open);
  source__51934.addEventListener("message", grimoire_client.core.on_message);
  return source__51934.addEventListener("error", grimoire_client.core.on_error)
};
goog.exportSymbol("grimoire_client.core.init", grimoire_client.core.init);
